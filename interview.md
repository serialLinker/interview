...
- on voudrait récupérer les informations d'un user à partir de son id
- on voudrait ajouter la notion de permissions, les données sont déjà présentes en base de données, mais ne sont pas remontées via le endpoint
- on a un problème de lenteur sur le endpoint existant 
  - http://localhost:8080/users
- on voudrait pouvoir ajouter des utilisateurs via un endpoint
- on voudrait ajouter un endpoint qui permet d'appeler une api externe et qui remonte une liste de product à partir de leurs ids
